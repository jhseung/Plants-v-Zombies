...
ag=" : flags Open_text and Open_binary are not compatible",T="Sys_error",af=224,ae="Invalid_argument",s=1024,ad="fs",z="jsError",S=57343,ac=512,ab="End_of_file",aa="Failure",Q="Undefined_recursive_module",R=" : flags Open_rdonly and Open_wronly are not compatible",P="([^/]*)",$="Stack_overflow",g=128,b="",y="^",L=" : file already exists",M=2048,N=56320,O=240,f=248,Z="Not_found",_="undefined",K="Assert_failure",m="/",X="Sys_blocked_io",Y="fd ",J="Out_of_memory",W="Match_failure",U="Division_by_zero",V="static/",aF=0;function
q(){return aF++}function
...
if(a>=56319||d+1==i||(j=f.charCodeAt(d+1))<N||j>S)c+="\xef\xbf\xbd";else{d++;a=(a<<10)+j-56613888;c+=String.fromCharCode(O|a>>18,g|a>>12&63,g|a>>6&63,g|a&63)}if(c.length>s){c.substr(0,1);h+=c;c=b}}return h+c}function
...
f=b;for(;0<a;d+=s,a-=s)f+=e.apply(null,aV(c,d,Math.min(a,s)));return f}function
...
v(d,e,b,f,c){if(c==0)return 0;if(f==0&&(c>=b.l||b.t==2&&c>=b.c.length)){b.c=d.t==4?D(d.c,e,c):e==0&&d.c.length==c?d.c:d.c.substr(e,c);b.t=b.c.length==b.l?0:2}else
...
ai(a){if(a.t!=4)B(a);return a.c}function
aO(a,c,b){b&=255;if(a.t!=4){if(c==a.c.length){a.c+=String.fromCharCode(b);if(c+1==a.l)a.t=0;return 0}B(a)}a.c[c]=b;return 0}function
...
e=new
A(a);this.fs.writeSync(this.fd,e,c,f,g);return 0};l.prototype.read=function(h,e,c,g){var
a=ai(e);if(!(a
instanceof
d.Uint8Array))a=new(d.Uint8Array)(a);var
f=new
A(a);this.fs.readSync(this.fd,f,c,g,h);for(var
...
r=t.match(/[^\/]*\//)[0],u=[];if(typeof
module!==_&&module.exports&&typeof
require!==_)u.push({path:r,device:new
k(r)});else
u.push({path:r,device:new
h(r)});u.push({path:r+V,device:new
h(r+V)});function
aW(b){var
...
instanceof
d.Error&&ao(z))return[0,ao(z),b];return[0,a.Failure,C(String(b))]}var
E=[f,c(T),-2];i(11,[f,c(Q),-12],Q);i(10,[f,c(K),-11],K);i(9,[f,c(X),-10],X);i(8,[f,c($),-9],$);i(7,[f,c(W),-8],W);i(6,[f,c(Z),-7],Z);i(5,[f,c(U),-6],U);i(4,[f,c(ab),-5],ab);i(3,[f,c(ae),-4],ae);i(2,[f,c(aa),-3],aa);i(1,E,T);i(0,[f,c(J),-1],J);q(0);aC(0);am(1);am(2);q(0);q(0);q(0);var
F=[0,0],ay=c("Js.Error");function
G(a){F[1]=[0,a,F[1]];return 0}var
H=d,ax=H.Array,I=[f,ay,q(0)],x=[0,I,{}],aw=undefined,av=aE(x)===f?x:x[1];aI(c(z),av);(function(a){throw a});G(function(a){return a[1]===I?[0,C(a[2].toString())]:0});G(function(a){return a
instanceof
ax?0:[0,C(a.toString())]});q(0);H.HTMLElement===aw;function
au(b){var
a=b;for(;;){if(a){var
c=a[2],d=a[1];try{aB(d)}catch(a){a=aS(a);if(a[1]!==E)throw a}var
